...
using HexaEmployee.EfInfraData.Tests.Fixtures;
using System.Collections.Generic;
using System.Linq;
using Xunit;

namespace HexaEmployee.EfInfraData.Tests.Repositories
{
    public class SampleRepositoryTests
    {
        ...
        private SampleRepository BuildRepository(DbContextFixture context) =>
            new(context);
    }
}
